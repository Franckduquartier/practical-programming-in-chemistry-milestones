...
| Week | Milestone                                   | Link                                                                        |      
|------|---------------------------------------------|-----------------------------------------------------------------------------|
| 1    | Github Account Created                      | https://github.com/Franckduquartier                                               | 
| 1    | Github Profile Page                         | https://github.com/Franckduquartier/Franckduquartier                                   |
| 1    | Commit and Push Change from Command Line    | https://github.com/Franckduquartier/ppchem/commit/main                |
| 1    | Create a New Branch                         | https://github.com/Franckduquartier/ppchem/tree/new-branch-name            |
| 1    | Create a conda environment                  | https://github.com/Franckduquartier/ppchem/blob/main/env.yml      |
| 1    | Fork a Repo                                 | https://github.com/Franckduquartier/practical-programming-in-chemistry-milestones |
| 1    | (Optional) Make a Pull Request              | |
| 2    | (Optional) Review a Pull Request            | |
| 4    | Update `env.yml` via a Pull Request         | https://github.com/Franckduquartier/ppchem/pull/1
